...
pub struct DialManager {
    ...
    /// Maps a [`ConnectionId`] to the corresponding `app_public_key`.
...
impl DialManager {
    ...
    /// Insert a new queue for `app_public_key`.
